...
export async function lintSAMLResponse({
  ...
  // this vuln does not have a CVE assigned yet, but is essentially very similar to
  // CVE-2017-11428 and friends
  ...
  // this vuln does not have a CVE assigned yet either
